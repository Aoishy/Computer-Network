...
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    bool ShouldIgnoreRequest(ns3::Ipv4Address src, ns3::aodv::RevRreqHeader &revreqHeader);
    void BroadcastRreq( ns3::aodv::RevRreqHeader &revreqHeader);
    bool UpdateOrCreateRoute(ns3::Ipv4Address receiver,ns3::Ipv4Address src,
                                        ns3::aodv::RevRreqHeader &revreqHeader,ns3::aodv::RoutingTableEntry &toDst);
    void AddNewRoute(ns3::Ipv4Address receiver,ns3::Ipv4Address src,ns3::aodv::RevRreqHeader &revreqHeader) ;
    void UpdateExistingRoute(ns3::Ipv4Address src,ns3::Ipv4Address receiver,
                                         ns3::aodv::RevRreqHeader &revreqHeader,ns3::aodv::RoutingTableEntry &toDst)  ;                          
